      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 z-50 w-[420px] max-w-[calc(100vw-2rem)] -translate-x-1/2 -translate-y-1/2 rounded-xl bg-white p-5 shadow-2xl">
          ...
          <div className="mt-4 flex flex-col gap-2">
            <button
              className="rounded-lg border border-red-200 bg-red-50 px-3 py-2 text-start hover:bg-red-100"
            ...
            <button
              className="rounded-lg border border-slate-200 px-3 py-2 text-start hover:bg-slate-50"
